...
export default function QueueDoneListView({ setDoneTotal }: Props) {
  ...
  const {
    ...
    context: {
      requestTrackerId: 'getQueuesDone[Apt-Dash-queue]',
    },
  ...
  useEffect(() => {
    if (doneData) setDoneTotal(totalData);
  }, [doneData, setDoneTotal, totalData]);
  // useEffect(() => {
  //   getData({
  //     variables: {
  //       data: {
