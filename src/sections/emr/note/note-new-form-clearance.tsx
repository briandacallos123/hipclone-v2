...
import { POST_MED_CLER_EMR } from 'src/libs/gqls/notes/notesMedClear';
// _mock
...
export default function NoteNewFormClearance({ onClose, data: emrRef, refetch: onRefetch }: Props) {
  ...
  const [createNotesText] = useMutation(POST_MED_CLER_EMR);
  ...
  const handleSubmitValue = useCallback(
    ...
    [createNotesText, enqueueSnackbar, reset, snackKey]
  );
