...
// prisma
import { POST_NOTES_SOAP_EMR } from '@/libs/gqls/notes/notesSoap';
...
export default function NoteNewFormSoap({ onClose, data: emrRef, refetch: onRefetch }: Props) {
  const {emrfetchCover, setemrfetchCover }: any = useContextData();
  ...
  const [createSoap] = useMutation(POST_NOTES_SOAP_EMR);
  ...
  const handleSubmitValue = useCallback(
    ...
    [createSoap, enqueueSnackbar, isLinked, refIdEMR, refIdPatient, reset, snackKey]
  );
