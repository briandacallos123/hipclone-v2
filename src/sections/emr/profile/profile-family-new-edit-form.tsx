...
export default function ProfileFamilyNewEditForm({
  refetch,
  isLoading2,
  setLoading2,
  currentItem,
  ...
  const { id }: any = params;
  // console.log(tableDataFamilyHistory,"tableDataFamilyHistory")
  ...
  const handleSubmitValue = useCallback(
    async (model: NexusGenInputs['family_history_input_request']) => {
