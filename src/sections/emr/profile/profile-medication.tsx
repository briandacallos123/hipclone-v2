...
//
import { emr_view_patient_medication_data } from '@/libs/gqls/medicalProfile';
...
export default function EmrProfileMedication({ data, clientside, loading: loading1 }: Props) {
  ...
  const {
    ...
    loading,
    refetch,
  }: any = useQuery(emr_view_patient_medication_data, {
    context: {
      requestTrackerId: 'emr_view_patient_medication_data[emr_view_medication_input_request]',
    },
  ...
  useEffect(() => {
    if (data2) {
      const { emr_view_patient_medication_data } = data2;
      // console.log(data2, 'data2');
      if (data2) {
        // const { emr_view_patient_medication_data } = data;
        setTableData(emr_view_patient_medication_data?.emr_view_medication_data);
        setTableData1(emr_view_patient_medication_data?.emr_medication_data);
        setTotalRecords(emr_view_patient_medication_data?.total_records);
        setAllData((prev: any) => {
          return { ...prev, medication: emr_view_patient_medication_data?.emr_medication_data };
        });
