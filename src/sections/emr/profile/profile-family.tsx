...
//
import { emr_view_patient_family_history_data } from '@/libs/gqls/medicalProfile';
...
export default function EmrProfileFamily({ data, clientside, loading: loading1 }: Props) {
  ...
  // console.log(clientside,"clientsideclientside")
  ...
  const {
    ...
    loading,
    refetch,
  }: any = useQuery(emr_view_patient_family_history_data, {
    context: {
      requestTrackerId:
        'emr_view_patient_family_history_data[emr_view_family_history_input_request]',
    },
  ...
  useEffect(() => {
    if (data2) {
      const { emr_view_patient_family_history_data } = data2;
      setTableData(emr_view_patient_family_history_data?.emr_family_history_data);
      setTableData1(emr_view_patient_family_history_data?.emr_family_history_data_view);
      setTotalRecords(emr_view_patient_family_history_data?.total_records);
      setAllData((prev: any) => {
        return {
          ...prev,
          family_history: emr_view_patient_family_history_data?.emr_family_history_data_view,
        };
      });
  ...
  return (
    <>
      ...
      <EmrProfileCreateView
        tableDataFamilyHistory={tableData}
