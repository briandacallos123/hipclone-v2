...
//
import { view_patient_medical_history_data } from '@/libs/gqls/medicalProfile';
...
export default function PatientProfileMedical({ data, clientside, loading1: loading1 }: Props) {
  ...
  const {
    ...
    loading,
    refetch,
  }: any = useQuery(view_patient_medical_history_data, {
    context: {
      requestTrackerId: 'view_patient_medical_history_data[view_medical_history_input_request]',
    },
  ...
  useEffect(() => {
    if (data2) {
      const { view_patient_medical_history_data } = data2;
      setTableData(view_patient_medical_history_data?.view_medical_history_data);
      setTableLoading(false);
      setTableData1(view_patient_medical_history_data?.medical_history_data);
      setTotalRecords(view_patient_medical_history_data?.total_records);
      setAllData((prev: any) => {
        return {
          ...prev,
          medical_history: view_patient_medical_history_data?.medical_history_data,
        };
      });
