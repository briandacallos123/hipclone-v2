...
export default function ProfileMedicalNewEditForm({isLoading3, setLoading3,currentItem, onClose,clientside,refetch}: Props) {
 ...
 ////////////////////////////////////////////////////////////////////////////
    ...
    const [create_medical_history] = useMutation(mutation_create_medical_history, {
      ...
      ////////////////////////////////////////////////////////////////////////////
      const handleSubmitValue = useCallback(async (model: NexusGenInputs['medical_history_input_request']) => {
...
const values = watch();
  ...
  const onSubmit = useCallback(
    async (data: any) => {
      ...
      try {const snackbarKey:any = enqueueSnackbar('Saving Data...', {
            variant: 'info',
