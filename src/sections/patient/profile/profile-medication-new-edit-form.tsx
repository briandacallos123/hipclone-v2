...
export default function ProfileMedicationNewEditForm({isLoading4, setLoading4,currentItem, onClose, clientside,refetch }: Props) {
  ...
  ////////////////////////////////////////////////////////////////////////////
    ...
    const [create_medication] = useMutation(mutation_create_medication, {
      ...
      ////////////////////////////////////////////////////////////////////////////
      const handleSubmitValue = useCallback(async (model: NexusGenInputs['medication_input_request']) => {
