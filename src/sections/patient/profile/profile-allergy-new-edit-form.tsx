...
export default function ProfileAllergyNewEditForm({isLoading, setLoading,currentItem, onClose, clientside,refetch}: Props) {
  const { enqueueSnackbar,closeSnackbar } = useSnackbar();
  const [snackKey, setSnackKey]:any = useState(null);
//  console.log(refetch,'asdasdrefetch')
  ...
  const handleRemove = (index: number) => {
    ...
    ////////////////////////////////////////////////////////////////////////////
    const handleSubmitValue = useCallback(async (model: NexusGenInputs['allergy_input_request']) => {
        ...
        if (snackKey) {
          (async () => {
            await handleSubmitValue({
              ...values,
              patientID:Number(values?.patientID), // need pa i condition nitong dalawa based kung nasaang page ba yung user
              emrPatientID:null, // need pa i condition nitong dalawa based kung nasaang page ba yung user
