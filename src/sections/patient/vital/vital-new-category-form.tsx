...
export default function VitalNewCategoryForm({uuid, addedCategory, onClose, items, refetch, user }: Props) {
  // user na to
  ...
  const handleSubmitValue = useCallback(
    ...
    [createVitals, enqueueSnackbar, items?.patientID, items?.report_id, refetch, reset, uuid]
  );
  ...
  const onSubmit = useCallback(
    ...
    [enqueueSnackbar, handleSubmitValue, onClose, refetch, reset, uuid]
  );
