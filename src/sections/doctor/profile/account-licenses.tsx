...
export default function AccountLicenses({ dataVal }: any) {
  ...
  const defaultValues = {
    prcNumber: dataVal?.PRC ?? '',
    prcExpiry: new Date(dataVal?.validity),
    ptrNumber: dataVal?.PTR ?? '',
    s2Number: dataVal?.s2_number || '',
    since: dataVal?.practicing_since || '',
  };

  console.log(dataVal, defaultValues, 'HEHEHEHEEEEEEEEEEEEEEEEE');
      ...
      <Card sx={{ p: 3 }}>
        ...
        >
          <RHFTextField
            ...
            name="prcNumber" label="PRC Number" />
          ...
          <RHFTextField InputProps={{
            readOnly: true,
          }} name="ptrNumber" label="PTR Number" />
          <RHFTextField InputProps={{
            readOnly: true,
          }} name="s2Number" label="S2 Number" />
          <RHFTextField InputProps={{
            readOnly: true,
          }} name="since" label="Practicing Since (Year)" />
