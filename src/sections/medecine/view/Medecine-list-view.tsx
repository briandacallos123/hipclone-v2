  ...
  return (
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        >
          <Typography variant="h5">Medecines</Typography>
          ...
          <TableContainer sx={{ position: 'relative', overflow: 'unset' }}>
            ...
            <Scrollbar>
              <Table size={table.dense ? 'small' : 'medium'} sx={{ minWidth: { md: 800 } }}>
                ...
                <TableBody>
                  {state?.isLoading
                    ? [...Array(rowsPerPage)].map((_, i) => <MedecineSkeleton key={i} />)
...
{/* 
      ...
      />} */}
      {/* <MedecineCreateView open={confirmOrder?.value} onClose={confirmOrder.onFalse}/> */}
